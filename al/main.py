# client = OpenAI(api_key="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")
import os
...
def generate_blog_outline(product_url, product_title, product_description,
    ...
    10. Tone: Use a conversational and engaging tone to make the content more transactional.
...
def generate_section(content_type, word_count, product_url, product_title, product_description,
    ...
    9. Calls-to-Action: Include clear calls-to-action to encourage readers to take the next step.
